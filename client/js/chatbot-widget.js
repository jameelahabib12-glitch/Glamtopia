...
(function () {
  ...
  style.textContent = `
    #gt-chatbot-toggle {
      ...
      background: #0F3040; color: #fff; font-size: 24px; cursor: pointer;
    ...
    #gt-chatbot-header {
      background: #0F3040; color: #fff; padding: 14px 16px;
    ...
    .gt-msg.bot { background: #F4E9E3; color: #464858; align-self: flex-start; }
    .gt-msg.user { background: #0F3040; color: #fff; align-self: flex-end; }
    .gt-faq-chip {
      text-align: left; background: #fff; border: 1px solid rgba(70,72,88,0.25);
      border-radius: 8px; padding: 6px 10px; font-size: 12px; cursor: pointer;
      margin-top: 4px;
    }
    .gt-faq-chip:hover { background: #F4E9E3; border-color: #D99B7F; }
    #gt-chatbot-input-row { display: flex; border-top: 1px solid rgba(70,72,88,0.2); }
    #gt-chatbot-input {
      flex: 1; border: none; padding: 10px 12px; font-size: 13px; outline: none;
    }
    #gt-chatbot-send {
      border: none; background: #0F3040; color: #fff; padding: 0 16px; cursor: pointer;
    }
  `;
